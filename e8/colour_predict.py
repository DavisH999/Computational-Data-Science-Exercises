...
def main():
    ...
    # KNeighborsClassifier for RGB
    knn_rgb_model = KNeighborsClassifier(n_neighbors=15)

    # KNeighborsClassifier for HSV
    knn_convert_model = make_pipeline(FunctionTransformer(rgb2hsv),
                                      KNeighborsClassifier(n_neighbors=100))

    # RandomForestClassifier for RGB
    rf_rgb_model = RandomForestClassifier(n_estimators=100, max_depth=3, min_samples_leaf=10)

    # RandomForestClassifier for HSV
    rf_convert_model = make_pipeline(FunctionTransformer(rgb2hsv),
